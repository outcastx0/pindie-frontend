  ...
  return (
    <section className={Styles.promo}>
      <div className={Styles["promo__description-block"]}>
        ...
        <button className={`button ${Styles['promo__button']}`} onClick={handleButtonClick}>{codeIsVisible == true ? (<span className={Styles["promo-code"]}>WEBTEENS10</span>) : "Получить код"}</button>
      </div>
