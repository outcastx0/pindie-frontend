...
export const Header = () => {
  ...
  return (
    <header className={Styles['header']}>
      {pathname == '/' ? <img className={`${Styles.logo} ${Styles['logo__image']}`} src="../images/logo.svg" alt="Логотип Pindie" /> :
        <Link href=".." className={Styles['logo']}><img className={Styles['logo__image']} src="../images/logo.svg" alt="Логотип Pindie" /></Link>}

      <nav className={Styles['menu']}>
        <ul className={Styles['menu__list']}>
          <li className={Styles['menu__item']}>
            <Link
              href="/new" className={`${Styles["menu__link"]} ${pathname === "/new" ? Styles["menu__link_active"] : ""}`}>
              Новинки
            </Link>
          </li>
          <li className={Styles['menu__item']}>
      ...
      <Overlay isOpened={popupIsOpened} toClose={closePopup} />
      <Popup isOpened={popupIsOpened} toClose={closePopup}>
        <AuthForm close={closePopup} title={formTitle} setTitle={setFormTitle}/>
      </Popup>
    </header>
  )
}